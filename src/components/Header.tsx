  ...
  return (
    <header className="flex flex-row items-center justify-between px-5 py-3 bg-white dark:bg-gray-900 border-b border-border shadow-sm">
      <div className="flex items-center flex-1 overflow-hidden">
        {showBack && (
          <button onClick={handleBack} className="mr-3 p-1 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full transition-colors bg-transparent border-none cursor-pointer flex-shrink-0">
