...
export const AppLoader: React.FC<AppLoaderProps> = ({ isLoading, error, onRetry }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-white dark:bg-[#0f172a] flex justify-center items-center">
      <div className="w-full p-5 flex flex-col items-center">
        {error ? (
          <div className="w-full px-5 flex flex-col items-center animate-fade-in">
            <WifiOff size={48} className="text-red-500" />
            <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 mt-4 mb-2">Connection Error</h2>
          ...
          <div className="flex flex-col items-center animate-pulse">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300 font-semibold">Loading your content...</p>
          </div>
        )}
      </div>
    </div>
